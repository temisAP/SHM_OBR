...
if dataset == 'asimetrico':
    ...
    CM2_obj.curing_evol1D(REF='0.obr',points=[[2.22270236297664, 2.4415436926458973], [2.5719642830548493, 2.7664899094275226], [2.861542204132352, 3.0715414598755792], [3.206383087247546, 3.396487676657204], [3.4826978974360028, 3.7015392271052603]],cooling_time = 30, val='ss')
    ...
    #CM2_obj.curing_evol1D(REF='0.obr',val='ss')
    CM2_obj.curing_evol1D(REF='0.obr',points=[[2.1409131791608567, 2.2956494728663923], [2.3067020652739307, 2.4039648784602674], [2.5454380612767573, 2.7488057615754613], [2.823963389946722, 2.945541906429643], [2.963226054281704, 3.0759624968385944]],cooling_time = 30,val='ss')
