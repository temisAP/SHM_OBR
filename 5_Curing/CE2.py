...
if dataset == 'asimetrico':
    ...
    #CM2_obj.curing_evol1D(REF='8340.obr',points=[[2.22270236297664, 2.4415436926458973], [2.5719642830548493, 2.7664899094275226], [2.861542204132352, 3.0715414598755792], [3.206383087247546, 3.396487676657204], [3.4826978974360028, 3.7015392271052603]], val='ss')
    CM2_obj.curing_evol1D(REF='8340.obr', val='ss')
    ...
    #CM2_obj.curing_evol1D(REF='8700.obr',points=[[2.182913030309502, 2.2978599913479], [2.302281028310915, 2.384070212126699], [2.5520696167212806, 2.6493324299076173], [2.8372265008357678, 2.9013315367994896], [2.914594647688536, 2.9875417575782883]],val='ss')
    CM2_obj.curing_evol1D(REF='8700.obr', val='ss')
    ...
    #CM2_obj.curing_evol1D(REF='0.obr',val='ss')
    #CM2_obj.curing_evol1D(REF='0.obr',points=[[2.22270236297664, 2.4415436926458973], [2.5719642830548493, 2.7664899094275226], [2.861542204132352, 3.0715414598755792], [3.206383087247546, 3.396487676657204], [3.4826978974360028, 3.7015392271052603]], val='ss')
    #CM2_obj.curing_evol1D(REF='7980.obr',points=[[2.22270236297664, 2.4415436926458973], [2.5719642830548493, 2.7664899094275226], [2.861542204132352, 3.0715414598755792], [3.206383087247546, 3.396487676657204], [3.4826978974360028, 3.7015392271052603]], val='ss')
    CM2_obj.curing_evol1D(REF='7980.obr', val='ss')
